...
const NOTIFICATION_TYPE_LABELS: Record<NotificationType, { label: string; module: string }> = {
  ...
  vendor_submitted: { label: "ผู้ขายรอบัญชีอนุมัติ", module: "ทะเบียนผู้ขาย" },
  vendor_approved: { label: "บัญชีอนุมัติผู้ขายแล้ว", module: "ทะเบียนผู้ขาย" },
  vendor_rejected: { label: "บัญชีไม่อนุมัติผู้ขาย", module: "ทะเบียนผู้ขาย" },
