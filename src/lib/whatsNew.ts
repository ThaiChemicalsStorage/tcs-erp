...
export const WHATS_NEW_ENTRIES: WhatsNewEntry[] = [
  ...
  },
  {
    ...
    bullets: [
      "เข้าแต่ละหน้าครั้งแรก ระบบจะพาชมทีละจุดโดยอัตโนมัติ — ครอบคลุมทุกหน้า: ใบเสนอราคา, คลังสินค้า, Scope of Work, ใบส่งมอบสินค้า, ลูกค้า, Template ใบเสนอราคา, จัดการผู้ใช้งาน, บทบาทและสิทธิ์, บันทึกการใช้งาน และตั้งค่า (ข้ามได้ทุกเมื่อ และจะไม่เด้งซ้ำอีก)",
