...
export const WHATS_NEW_ENTRIES: WhatsNewEntry[] = [
  {
    ...
    date: "2026-07-24",
    title: "ส่งเอกสารซ้ำต่อในอีเมลเดิม + แนบลิงก์ใบส่งมอบสินค้าได้",
    bullets: [
      ...
      "ถ้าใบงานมีใบส่งมอบสินค้าแล้ว จะมีช่องติ๊ก 'แนบลิงก์ใบส่งมอบสินค้าในอีเมล' — ผู้รับกดเปิดดูใบส่งมอบจากอีเมลได้ทันทีโดยไม่ต้องเข้าสู่ระบบ",
    ],
  },
  {
