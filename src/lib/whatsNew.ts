...
export const WHATS_NEW_ENTRIES: WhatsNewEntry[] = [
  ...
  },
  {
    ...
    date: "2026-07-29",
    title: "ทัวร์แนะนำการใช้งานหน้าใบเสนอราคา คลังสินค้า Scope of Work และใบส่งมอบสินค้า",
    bullets: [
      "เข้าหน้าใบเสนอราคา คลังสินค้า Scope of Work หรือใบส่งมอบสินค้าครั้งแรก ระบบจะพาชมทีละจุดโดยอัตโนมัติ — ปุ่มสร้างเอกสาร การ์ดสรุป ช่องค้นหา/ตัวกรอง และตารางรายการ (ข้ามได้ทุกเมื่อ และจะไม่เด้งซ้ำอีก)",
      "ทัวร์หน้า Scope of Work ชี้ปุ่มกรอง 'เฉพาะที่ยังไม่มี PO' ให้ด้วย ส่วนหน้าใบส่งมอบสินค้าอธิบายว่าการพิมพ์แยกเป็นรายงวด",
