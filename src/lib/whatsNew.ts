...
export const WHATS_NEW_ENTRIES: WhatsNewEntry[] = [
  {
    id: "2026-08-07-cream-theme",
    date: "2026-08-07",
    title: "โฉมใหม่: พื้นหลังโทนครีมอบอุ่นทั้งระบบ",
    bullets: [
      "พื้นหลังและพื้นผิวของทุกหน้าเปลี่ยนจากโทนฟ้าอมเทาเป็นโทนครีมอบอุ่นแบบเดียวกับหน้าคู่มือการใช้งาน — สบายตาขึ้นเวลาใช้งานต่อเนื่องนานๆ",
      "สีประจำระบบเดิมยังอยู่ครบ: แถบเมนูสีกรมท่า ปุ่มสีทอง และสีป้ายสถานะเอกสารทุกสีเหมือนเดิม ไม่ต้องเรียนรู้อะไรใหม่",
    ],
  },
  {
    ...
    bullets: [
      ...
      "เพิ่มบทใหม่ 'การส่งอีเมลเอกสาร (Gmail)' — ขั้นตอนตั้งค่า App Password ทีละขั้น พร้อมตารางแก้ปัญหาและวิธีเช็คว่าอีเมลถึงผู้รับ",
      "ยังพิมพ์เป็น PDF ได้เหมือนเดิม — เปิดคู่มือแล้วกด Ctrl+P เลือก Save as PDF",
    ],
  },
  {
    id: "2026-08-07-gmail-personal-sending",
    date: "2026-08-07",
    title: "อีเมลเอกสาร Scope of Work ส่งจาก Gmail ของคุณเองแล้ว",
    bullets: [
      "อีเมลแจ้งผู้รับเอกสารส่งออกจากอีเมล Gmail ส่วนตัวของคนที่กดส่งโดยตรง — ผู้รับเห็นชื่อและอีเมลผู้ส่งจริง และตอบกลับหาผู้ส่งได้ทันที (เดิมส่งจากที่อยู่กลางของระบบ ตอบกลับไม่ได้)",
      "ก่อนส่งครั้งแรก ต้องตั้งค่า Gmail App Password ของตัวเองที่ ตั้งค่า → ความปลอดภัย → การส่งอีเมล (ต้องเปิดการยืนยันแบบ 2 ขั้นตอนในบัญชี Google ก่อน แล้วสร้างรหัสที่ myaccount.google.com/apppasswords) — มีปุ่มส่งอีเมลทดสอบถึงตัวเองไว้ตรวจสอบ",
      "เพิ่มช่อง 'ผู้รับเพิ่มเติม' ในหน้าผู้รับเอกสาร — เลือกพนักงานคนไหนก็ได้จากทุกแผนก (มีช่องค้นหา) ไม่จำกัดเฉพาะแผนกที่ติ๊กไว้ใน 'เอกสารส่งถึง' อีกต่อไป",
    ],
  },
  {
