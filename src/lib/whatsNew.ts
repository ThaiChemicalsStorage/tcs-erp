...
export const WHATS_NEW_ENTRIES: WhatsNewEntry[] = [
  ...
  },
  {
    ...
    date: "2026-07-29",
    title: "ทัวร์แนะนำการใช้งานหน้าใบเสนอราคาและคลังสินค้า",
    bullets: [
      "เข้าหน้าใบเสนอราคาหรือคลังสินค้าครั้งแรก ระบบจะพาชมทีละจุดโดยอัตโนมัติ — ปุ่มสร้างเอกสาร การ์ดสรุป ช่องค้นหา/ตัวกรอง และตารางรายการ (ข้ามได้ทุกเมื่อ และจะไม่เด้งซ้ำอีก)",
