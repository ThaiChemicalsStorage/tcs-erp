...
export const defaultRoles: Role[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      "products:view",
      "customers:view",
      "scopeOfWork:view", "scopeOfWork:viewAll", "scopeOfWork:edit", "scopeOfWork:finalize", "scopeOfWork:print",
    ],
    isSuperAdmin: false,
    isSystem: false,
  },
  ...
  },
  {
    ...
    permissions: ["dashboard:view", "quotations:view", "quotations:viewAll", "products:view", "customers:view", "scopeOfWork:view", "scopeOfWork:viewAll"],
    isSuperAdmin: false,
    isSystem: false,
  },
];
