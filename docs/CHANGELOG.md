...
## 2026-08-31h (absolute latest) — Cost Control ถอดบล็อกกำไรออกทั้งโมดูล
...
- `npm test` — 511 ข้อผ่านทั้งหมด (42 ไฟล์) · เทสต์ที่ยืนยันสูตรกำไร/ราคาขายถูกเขียนใหม่หรือถอดออก
