...
`tsc` (ทั้งสอง config) · `lint` (0 error) · `build` · `npm test` **539/539 ผ่าน** (เพิ่ม 16 ข้อ:
`tests/printFormat.test.ts` 11 ข้อ และการแจ้งเตือนของใกล้หมดใน `tests/api/stockMovements.test.ts` 5 ข้อ)
