...
│   │   ├── quotation/             # QuotationPage, QuoteList, QuoteDocument, LineItemsEditor, InterestButtons, notesFormat, CustomerSelector (added 2026-07-14, replaces the incorrect 2026-07-13 IssuerCompanySelector), PrintDocument, QuotationTemplateWizard + applyTemplate.ts (Create Quotation wizard, added 2026-07-14)
...
| [MODULES/](./MODULES/) | Per-module deep dive (Dashboard, Quotation, QuotationTemplates, Product, Lead, Customer, Auth, Settings, CompanyProfiles) |
