...
- **2026-09-24h — ผู้ออกบิลเหลือช่องพิมพ์ช่องเดียว** (เจ้าของ: *"ตรง Bill by ให้ทำเป็นแค่ textbox พอเอาไปกรอกเอง"*) — เว้นว่าง = ใช้ผู้ขาย ·
  หน้าจอตั้ง `billerCustom` ตามว่ามีชื่อไหม (ข้อมูลและ `billerOf()` เหมือนเดิม) · ช่องเลขผู้เสียภาษี/ที่อยู่ของผู้ออกบิลถูกถอด และพิมพ์ชื่อใหม่เมื่อไร
  ล้างสองค่านั้นทิ้ง (ไม่ให้ค่าที่มองไม่เห็นไปโผล่ในทะเบียนเจ้าหนี้/ใบพิมพ์) · ช่องส่วนลดท้ายบิลที่ถูกบีบจนเหลือนิดเดียวแก้แล้ว (ช่องหน่วยเคยยืดเต็มแถว)
