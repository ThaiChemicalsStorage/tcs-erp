...
- Notification clicks currently only navigate to the quotation list, not the specific quote — needs `QuotationPage`'s view/selectedId state lifted to `App.tsx`
