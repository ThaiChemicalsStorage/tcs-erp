...
**สองข้อสังเกตที่ยังไม่ได้แก้** (จดไว้ใน [TODO.md](../TODO.md)):
1. กล่องงานเข้าของจัดซื้อไม่ได้กรอง `storeStage` ใบที่ยังรอสโตร์อยู่ก็ขึ้นในรายการ (มีป้าย
   *รอสโตร์เช็คของ* กำกับ และกดออกใบสั่งซื้อไม่ได้อยู่แล้ว) ต่างจากกล่องของสโตร์ที่กรอง `?storeStage=pending`
2. เมนู *ใบขอซื้อ (รอสโตร์เช็คของ)* กับ *ใบขอซื้อ (ทุกฝ่าย)* เปิดด้วย `purchaseRequest:view` เฉย ๆ
   คนที่เป็นแค่ผู้ขอซื้อจึงเห็นกล่องงานของสโตร์และของจัดซื้อไปด้วย (กดทำอะไรไม่ได้ เพราะการจ่ายของ
   ต้องมี `stock:adjust` และการออกใบสั่งซื้อต้องมี `purchaseOrder:create`)
